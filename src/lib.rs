// src/lib.rs
/*
 * Core library for MessagePackSerializer
 */
...
#[derive(Debug)]
pub struct MessagePackSerializerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MessagePackSerializerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MessagePackSerializer processing");
    
    let mut processor = MessagePackSerializerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MessagePackSerializerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MessagePackSerializerProcessor::new(false);
